Hello, this is a project based on Gulp Starter Pack.

To get started, make sure you have installed Node and NPM.

 1. Install your dependencies with `npm install`
 2. Start the project with `npm start`
 3. This will load a browser window running on port 3000

**Scripts**
 1. src/javascripts/app.js is your main scripts file, this project is using ES6 modules. Create new modules in /modules directory. You will have to import in your modules into app.js and call them as needed.
...
**Testing**
 ...
 1. Tests are being run with Chai!
 2. Run tests with `npm run test`
 3. Tests are located javascripts/__tests__
 4. To add another test, just add another file to this directory (__tests__) with the .test.js extension. 
